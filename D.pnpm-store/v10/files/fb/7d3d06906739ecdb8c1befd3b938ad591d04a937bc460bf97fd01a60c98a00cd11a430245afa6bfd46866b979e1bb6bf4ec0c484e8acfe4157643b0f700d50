...
import { a1 as FieldAttribute, B as BetterAuthOptions, h as BetterAuthPlugin } from '../../shared/better-auth.BDi4weGR.cjs';
...
import { S as Store } from '../../shared/better-auth.MQKGNeOa.cjs';
import { sso } from '../../plugins/sso/index.cjs';
import { oidcProvider } from '../../plugins/oidc-provider/index.cjs';
import { a as apiKey } from '../../shared/better-auth.Ay7JnuoB.cjs';
