...
import { C as ClientOptions, B as BetterAuthClientPlugin, I as IsSignal, a as InferClientAPI, b as InferActions, c as InferErrorCodes } from '../../shared/better-auth.p6Acef0D.js';
import { U as UnionToIntersection, P as PrettifyDeep } from '../../shared/better-auth.Bi8FQwDD.js';
import { f as BASE_ERROR_CODES } from '../../shared/better-auth.DdmVKCUf.js';
import 'better-call';
import 'zod';
