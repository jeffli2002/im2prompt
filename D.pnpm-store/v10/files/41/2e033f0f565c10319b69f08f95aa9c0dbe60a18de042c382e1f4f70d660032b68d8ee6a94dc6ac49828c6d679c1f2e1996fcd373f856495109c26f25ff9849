...
const listCustomers_js_1 = require("../funcs/listCustomers.js");
...
class Creem extends sdks_js_1.ClientSDK {
    ...
    async listCustomers(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, listCustomers_js_1.listCustomers)(this, request, options));
    }
    /**
     * Retrieve a customer
     */
     ...
     */
    async getTransactionById(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, getTransactionById_js_1.getTransactionById)(this, request, options));
    }
    /**
