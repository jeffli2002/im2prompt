import { f as BASE_ERROR_CODES, h as BetterAuthPlugin, B as BetterAuthOptions } from '../shared/better-auth.DdmVKCUf.js';
import * as _better_fetch_fetch from '@better-fetch/fetch';
import { BetterFetchError, BetterFetch, BetterFetchOption } from '@better-fetch/fetch';
export * from '@better-fetch/fetch';
import { C as ClientOptions, B as BetterAuthClientPlugin, I as IsSignal, a as InferClientAPI, b as InferActions, c as InferErrorCodes, h as InferRoutes } from '../shared/better-auth.p6Acef0D.js';
export { A as AtomListener, g as InferAdditionalFromClient, d as InferPluginsFromClient, e as InferSessionFromClient, f as InferUserFromClient, S as Store } from '../shared/better-auth.p6Acef0D.js';
