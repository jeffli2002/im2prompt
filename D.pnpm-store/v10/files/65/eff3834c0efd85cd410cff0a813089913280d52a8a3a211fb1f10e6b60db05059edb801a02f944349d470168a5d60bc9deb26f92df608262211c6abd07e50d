...
exports.MAX_ARGUMENT_FOR_STACK = exports.isServer = void 0;
exports.safeArrayPush = safeArrayPush;
exports.sprintf = sprintf;
exports.formatBytes = formatBytes;
exports.isInsideWebWorker = isInsideWebWorker;
exports.isInsideNode = isInsideNode;
exports.getNanosecondTimeViaPerformance = getNanosecondTimeViaPerformance;
...
exports.getDocumentProperties = getDocumentProperties;
exports.getNested = getNested;
exports.flattenObject = flattenObject;
exports.convertDistanceToMeters = convertDistanceToMeters;
exports.removeVectorsFromHits = removeVectorsFromHits;
 ...
 */
exports.MAX_ARGUMENT_FOR_STACK = 65535;
/**
...
function safeArrayPush(arr, newArr) {
    if (newArr.length < exports.MAX_ARGUMENT_FOR_STACK) {
        Array.prototype.push.apply(arr, newArr);
    }
    else {
        const newArrLength = newArr.length;
        for (let i = 0; i < newArrLength; i += exports.MAX_ARGUMENT_FOR_STACK) {
            Array.prototype.push.apply(arr, newArr.slice(i, i + exports.MAX_ARGUMENT_FOR_STACK));
        }
    }
}
...
function convertDistanceToMeters(distance, unit) {
    ...
    if (ratio === undefined) {
        throw new Error((0, errors_js_1.createError)('INVALID_DISTANCE_SUFFIX', distance).message);
    }
