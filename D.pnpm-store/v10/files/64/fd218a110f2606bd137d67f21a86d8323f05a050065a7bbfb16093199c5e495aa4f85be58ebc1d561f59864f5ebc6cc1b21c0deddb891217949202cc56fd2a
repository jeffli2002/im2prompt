...
import { U as User, p as AuthContext } from '../../shared/better-auth.BDi4weGR.cjs';
import { z } from 'zod';
import { O as OAuth2Tokens, a as OAuthProvider } from '../../shared/better-auth._1abrCm_.cjs';
