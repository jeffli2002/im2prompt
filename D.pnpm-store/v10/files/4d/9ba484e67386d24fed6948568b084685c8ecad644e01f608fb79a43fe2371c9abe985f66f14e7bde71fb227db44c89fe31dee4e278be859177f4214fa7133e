import { L as LiteralString, b as Prettify } from './better-auth.Bi8FQwDD.js';
import { z } from 'zod';
...
export { twitter as E, dropbox as J, linkedin as N, gitlab as U, tiktok as X, reddit as _, roblox as a1, LANG as a3, vk as a5, zoom as ac, kick as af, huggingface as ai, socialProviderList as c, SocialProviderListEnum as d, github as g, google as j, apple as m, getApplePublicKey as n, microsoft as p, discord as r, socialProviders as s, spotify as v, twitch as x, facebook as z };
export type { RobloxProfile as $, AppleProfile as A, TwitterProfile as B, TwitterOption as C, DiscordProfile as D, FacebookProfile as F, GithubProfile as G, DropboxProfile as H, DropboxOptions as I, LinkedInOptions as K, LinkedInProfile as L, MicrosoftEntraIDProfile as M, OAuth2Tokens as O, ProviderOptions as P, GitlabProfile as Q, GitlabOptions as R, SocialProviders as S, TwitchProfile as T, TiktokProfile as V, TiktokOptions as W, RedditProfile as Y, RedditOptions as Z, OAuthProvider as a, RobloxOptions as a0, VkProfile as a2, VkOption as a4, LoginType as a6, AccountStatus as a7, PronounOption as a8, PhoneNumber as a9, ZoomProfile as aa, ZoomOptions as ab, KickProfile as ad, KickOptions as ae, HuggingFaceProfile as ag, HuggingFaceOptions as ah, SocialProviderList as b, SocialProvider as e, GithubOptions as f, GoogleProfile as h, GoogleOptions as i, AppleNonConformUser as k, AppleOptions as l, MicrosoftOptions as o, DiscordOptions as q, SpotifyProfile as t, SpotifyOptions as u, TwitchOptions as w, FacebookOptions as y };
