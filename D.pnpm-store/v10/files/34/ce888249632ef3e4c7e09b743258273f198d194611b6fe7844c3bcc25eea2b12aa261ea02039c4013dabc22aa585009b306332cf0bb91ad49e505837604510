...
exports.CheckoutEntity$ = exports.CheckoutEntity$outboundSchema = exports.CheckoutEntity$inboundSchema = exports.CheckoutEntityCustomer$ = exports.CheckoutEntityCustomer$outboundSchema = exports.CheckoutEntityCustomer$inboundSchema = exports.Subscription$ = exports.Subscription$outboundSchema = exports.Subscription$inboundSchema = exports.CheckoutEntityProduct$ = exports.CheckoutEntityProduct$outboundSchema = exports.CheckoutEntityProduct$inboundSchema = exports.CheckoutEntityStatus$ = exports.CheckoutEntityStatus$outboundSchema = exports.CheckoutEntityStatus$inboundSchema = exports.CheckoutEntityMode$ = exports.CheckoutEntityMode$outboundSchema = exports.CheckoutEntityMode$inboundSchema = exports.CheckoutEntityStatus = exports.CheckoutEntityMode = void 0;
...
/** @internal */
exports.CheckoutEntityStatus$inboundSchema = z.nativeEnum(exports.CheckoutEntityStatus);
/** @internal */
exports.CheckoutEntityStatus$outboundSchema = exports.CheckoutEntityStatus$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var CheckoutEntityStatus$;
(function (CheckoutEntityStatus$) {
    /** @deprecated use `CheckoutEntityStatus$inboundSchema` instead. */
    CheckoutEntityStatus$.inboundSchema = exports.CheckoutEntityStatus$inboundSchema;
    /** @deprecated use `CheckoutEntityStatus$outboundSchema` instead. */
    CheckoutEntityStatus$.outboundSchema = exports.CheckoutEntityStatus$outboundSchema;
})(CheckoutEntityStatus$ || (exports.CheckoutEntityStatus$ = CheckoutEntityStatus$ = {}));
/** @internal */
...
exports.CheckoutEntity$inboundSchema = z.object({
    ...
    object: z.string(),
    status: exports.CheckoutEntityStatus$inboundSchema,
...
exports.CheckoutEntity$outboundSchema = z.object({
    ...
    object: z.string(),
    status: exports.CheckoutEntityStatus$outboundSchema,
