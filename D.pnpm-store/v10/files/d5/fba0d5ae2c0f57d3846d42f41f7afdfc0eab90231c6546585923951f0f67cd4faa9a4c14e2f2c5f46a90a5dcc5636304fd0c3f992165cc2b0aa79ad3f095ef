...
/** @internal */
export const CheckoutEntityStatus$inboundSchema = z.nativeEnum(CheckoutEntityStatus);
/** @internal */
export const CheckoutEntityStatus$outboundSchema = CheckoutEntityStatus$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CheckoutEntityStatus$;
(function (CheckoutEntityStatus$) {
    /** @deprecated use `CheckoutEntityStatus$inboundSchema` instead. */
    CheckoutEntityStatus$.inboundSchema = CheckoutEntityStatus$inboundSchema;
    /** @deprecated use `CheckoutEntityStatus$outboundSchema` instead. */
    CheckoutEntityStatus$.outboundSchema = CheckoutEntityStatus$outboundSchema;
})(CheckoutEntityStatus$ || (CheckoutEntityStatus$ = {}));
/** @internal */
