import { h as BetterAuthPlugin, B as BetterAuthOptions, aa as InferFieldsInputClient, a8 as InferFieldsOutput, U as User, S as Session, n as Auth } from './better-auth.CdTbMvS8.mjs';
import { BetterFetchOption, BetterFetchResponse, BetterFetch, BetterFetchPlugin } from '@better-fetch/fetch';
import { WritableAtom, Atom } from 'nanostores';
import { U as UnionToIntersection, H as HasRequiredKeys, b as Prettify, L as LiteralString, S as StripEmptyObjects } from './better-auth.Bi8FQwDD.mjs';
...
export type { AtomListener as A, BetterAuthClientPlugin as B, ClientOptions as C, IsSignal as I, Store as S, InferClientAPI as a, InferActions as b, InferErrorCodes as c, InferPluginsFromClient as d, InferSessionFromClient as e, InferUserFromClient as f, InferAdditionalFromClient as g, InferRoutes as h };
