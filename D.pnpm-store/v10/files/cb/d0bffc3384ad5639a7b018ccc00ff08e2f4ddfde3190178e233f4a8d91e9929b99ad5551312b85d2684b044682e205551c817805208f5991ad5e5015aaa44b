...
import { a as getAdapter, c as createInternalAdapter, e as getMigrations } from './shared/better-auth.BGG5f0S_.mjs';
...
import { B as BASE_ERROR_CODES } from './shared/better-auth.cM0Fc3LZ.mjs';
export { H as HIDE_METADATA } from './shared/better-auth.cM0Fc3LZ.mjs';
...
import './shared/better-auth.C4F0dkzb.mjs';
import 'kysely';
import './shared/better-auth.DFIAchwv.mjs';
import './shared/better-auth.BCaUEQgP.mjs';
