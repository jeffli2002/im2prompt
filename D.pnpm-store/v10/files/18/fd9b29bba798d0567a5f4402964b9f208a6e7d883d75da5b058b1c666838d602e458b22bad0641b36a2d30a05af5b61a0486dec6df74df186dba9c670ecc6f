...
import { C as ClientOptions, B as BetterAuthClientPlugin, I as IsSignal, a as InferClientAPI, b as InferActions, c as InferErrorCodes } from '../../shared/better-auth.MQKGNeOa.cjs';
import { U as UnionToIntersection, P as PrettifyDeep } from '../../shared/better-auth.Bi8FQwDD.cjs';
import { f as BASE_ERROR_CODES } from '../../shared/better-auth.BDi4weGR.cjs';
import 'better-call';
import 'zod';
