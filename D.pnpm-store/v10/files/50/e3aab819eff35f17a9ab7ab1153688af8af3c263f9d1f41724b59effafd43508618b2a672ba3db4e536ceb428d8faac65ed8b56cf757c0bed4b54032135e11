...
const oidcProvider = (options) => {
  ...
  return {
    ...
    endpoints: {
      getOpenIdConfig: account.createAuthEndpoint(
      ...
      oAuth2authorize: account.createAuthEndpoint(
        "/oauth2/authorize",
        {
          method: "GET",
      ...
      oAuthConsent: account.createAuthEndpoint(
        "/oauth2/consent",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2token: account.createAuthEndpoint(
        "/oauth2/token",
        {
          method: "POST",
      ...
      oAuth2userInfo: account.createAuthEndpoint(
        "/oauth2/userinfo",
        {
          method: "GET",
          metadata: {
      ...
      registerOAuthApplication: account.createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: zod.z.object({
