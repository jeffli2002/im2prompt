...
export async function GET(req: NextRequest) {
  try {
    ...
    const contentType = searchParams.get('contentType') as 'image_to_prompt' | 'image_generation' | 'video_generation' | undefined;
    const status = searchParams.get('status') as 'processing' | 'completed' | 'failed' | 'expired' | undefined;
