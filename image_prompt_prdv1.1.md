...
## 1. Vision & Goals
Build an **end-to-end AI creative assistant** that extracts prompts from images, refines & translates them, and regenerates new visuals in one closed loop: **Image → Prompt → Image**.

---

## 2. Target Users
- AI Artists & Designers (Midjourney, Stable Diffusion, Flux)  
...
| **Prompt Variants** | 3 AI variations + auto negative prompt |
| **Preview Generation** | Stable Diffusion 256 px via Fal.ai (credit tracked in Neon) |
